...
public class CrearCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1365, 582));
        ...
        lblAcceder.setText("Crea una cuenta de Economizer");
        ...
        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 420, 470));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/bgDeCrearCuenta.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (DALUsuario.getUsuarios().buscar(user.getNUsuario())) {
            JOptionPane.showMessageDialog(null, "Usuario ya existe, elija otro nombre");
            txtUsuario.setText("");
            txtUsuario.requestFocus();
            return;
        }
        //Pila<Usuario> pilaDeUsuarios= DALUsuario.getUsuarios();
        //pilaDeUsuarios.push(user);
        DALUsuario.escribirUsuario(user);
