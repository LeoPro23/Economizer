 ...
 * @author lguim
 */
public class OlvidasteLaContraseña extends javax.swing.JFrame {
    ...
    public OlvidasteLaContraseña(JFrame parent) {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/imagenes/EconomizerIcon.png")).getImage());
        setExtendedState(MAXIMIZED_BOTH);
        bg.requestFocus();
    ...
    private void initComponents() {
        ...
        lblAcceder.setText("Recuperacion de la cuenta");
        ...
        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 80, 450, 470));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (usuario.isEmpty() || contraseña.isEmpty() || contraseña1.isEmpty()) {
            ...
            if (!contraseña.equals(contraseña1)) {
                ...
                if (!DALUsuario.getUsuarios().buscar(usuario)) {
                    ...
                    int numUsuario = DALUsuario.getUsuarioNum(user);
                    user.setContraseña(contraseña);
                    DALUsuario.setUsuario(numUsuario, user);

                    JOptionPane.showMessageDialog(null, "Cambio de contraseña realizado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OlvidasteLaContraseña.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OlvidasteLaContraseña().setVisible(true);
            }
        });
    }
